...
class Test_ChangeProfile():
    ...
    def test_request_without_platforms(resource_setup):
        ...
        assert finres[0] == {'Description': 'Done',
                             'Result': [{'Description': 'Done',
                                         'Status': 0,
                                         'platform': 'MT4_INSTANT_REAL1'},
                                        {'Description': 'Done',
                                         'Status': 0,
                                         'platform': 'MT4_INSTANT_REAL2'},
                                        {'Description': 'Done', 'Status': 0, 'platform': 'MT4_MARKET_REAL'},
                                        {'Description': 'Done',
                                         'Status': 0,
                                         'platform': 'MT4_MARKET_REAL2'}],
                             'Status': 0}
    ...
    def test_correct_value_to_platforms_two_servers(resource_setup):
        ...
        assert finres[0] == {'Description': 'Done', 'Result': [{'Description': 'Done', 'Status': 0, 'platform': 'MT4_MARKET_REAL'},
                                                                                              {'Description': 'Done', 'Status': 0, 'platform': 'MT4_INSTANT_REAL1'}], 'Status': 0}
...
class Test_request_ChangeServerSettings():
    ...
    def test_no_body_request(resource_setup):
        assert no_body_request_change_settings() == {"Description":"Done","Result":[{"Description":"Done","Status":0,"platform":"MT4_INSTANT_DEMO"},{"Description":"Done","Status":0,"platform":"MT4_INSTANT_REAL1"},{"Description":"Done","Status":0,"platform":"MT4_INSTANT_REAL2"},{"Description":"Done","Status":0,"platform":"MT4_MARKET_DEMO"},{"Description":"Done","Status":0,"platform":"MT4_MARKET_REAL"},{"Description":"Done","Status":0,"platform":"MT4_MARKET_REAL2"}],"Status":0}
    ...
    def test_symbol_not_found(resource_setup):
        assert symbol_not_found() == {"Description":"Some updates have failed","Result":[{"Description":" failed to get symbol info 'Test'","Status":7,"platform":"MT4_MARKET_REAL"}],"Status":7}
    ...
    def test_server_not_found(resource_setup):
        assert server_not_found() == {"Description":"Some updates have failed","Result":[{"Description":"No information in config","Status":2,"platform":"MT4_MARKET_REAL_TEST"}],"Status":7}
